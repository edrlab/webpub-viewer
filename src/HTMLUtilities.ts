...
export function findElement(parentElement: Element, selector: string): Element | null {
...
export function findRequiredElement(parentElement: Element, selector: string): Element {
